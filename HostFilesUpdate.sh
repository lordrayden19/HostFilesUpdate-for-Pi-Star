...
# Ambil data DMR_Hosts.txt dari lordrayden19
curl --fail -o ${DMRHOSTS} -s https://raw.githubusercontent.com/lordrayden19/DMR_Hosts/refs/heads/main/DMR_Hosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
...
# Ambil data DMRIds.dat dari lordrayden19
curl --fail -o ${DMRIDFILE} -s https://raw.githubusercontent.com/lordrayden19/DMR-Database/refs/heads/main/DMRIds.dat --user-agent "Pi-Star_${pistarCurVersion}"
...
# If there is a DMR Over-ride file, add it's contents to DMRIds.dat
